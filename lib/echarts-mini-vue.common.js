...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".chartBox[data-v-1d7356e4]{position:relative;pointer-events:none;background:#000}.chartBox .legth[data-v-1d7356e4]{position:absolute;left:321px;top:10px;width:100%}.chartBox .legth li[data-v-1d7356e4]{float:left;margin-right:20px;height:20px}.chartBox .legth li h3[data-v-1d7356e4]{float:left;width:20px;height:7px;margin-top:10px;background-color:red}.chartBox .legth li span[data-v-1d7356e4]{margin-left:7px;font-size:22px;font-family:PingFang;color:#bfebff}", ""]);
// Exports
...
var update = add("df19f984", content, true, {"sourceMap":false,"shadowMode":false});
...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./packages/chart-line-area/src/index.vue?vue&type=template&id=1d7356e4&scoped=true&
var srcvue_type_template_id_1d7356e4_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"chartBox"},[_c('div',{ref:"myChart",staticClass:"myChart",style:({ width: _vm.width, height: _vm.height })}),(_vm.legIsShow)?_c('ul',{staticClass:"legth",style:({ top: _vm.legTop, left: _vm.legLeft })},_vm._l((_vm.legthWZ),function(item,i){return _c('li',{key:i},[_c('h3',{style:({ backgroundColor: _vm.legthColor[i] })}),_c('span',[_vm._v(_vm._s(item))])])}),0):_vm._e()])}
var srcvue_type_template_id_1d7356e4_scoped_true_staticRenderFns = []
...
var src_component = normalizeComponent(
  ...
  srcvue_type_template_id_1d7356e4_scoped_true_render,
  srcvue_type_template_id_1d7356e4_scoped_true_staticRenderFns,
  false,
  null,
  "1d7356e4",
  null
...
// 存储组件列表
const components = [test_dome, chart_line_area];
